...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		Usuarios u1 = new Usuarios("Carlos", "123");
		Usuarios u2 = new Usuarios("Iñigo", "123");
		Usuarios u3 = new Usuarios("Alfredo", "123");
		...
		listaUsuarios.add(u3);
            ...
            if (!checked) {
            	...
            	for (int i = 0; i < listaUsuarios.size(); i++) {
            		...
            		if (usuario.equals(usuarios.getUsuario()) && contraseña.equals(usuarios.getContraseña())) {
            			checked = true;
        				System.out.println("El usuario existe y contraseña existen");
        			} 
            	}
            }
            if (!checked) {
            	System.out.println("Usuario o contraseña incorrectos, quedan 2 intentos");
            	System.out.println("Escribe el usuario: ");
        		usuario = sc.next();
        		System.out.println("Escribe la contraseña: ");
        		contraseña = sc.next();
            ...
            if (!checked) {
            	System.out.println("Usuario o contraseña incorrectos, queda 1 intento");
            	System.out.println("Escribe el usuario: ");
        		usuario = sc.next();
        		System.out.println("Escribe la contraseña: ");
        		contraseña = sc.next();
